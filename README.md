...
Deployment
Vercel/Netlify (frontend), Firebase Hosting


Version Control
Git + GitHub (main, dev, feature-*)
...
Open Pull Request: Submit a PR to dev for review.

Merge to main: After testing, merge dev into main for deployment.
